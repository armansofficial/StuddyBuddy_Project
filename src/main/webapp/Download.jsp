...
<div class="additional-content">
    ...
    <h1>How to download JDK.?</h1>
    <ul>
    <li>
    <b>Step.1</b>
    <P>Visit this given link below. this is the official website to download JDK</P>
    <a href="https://www.oracle.com/java/technologies/downloads/">Download Link</a>
    </li>
    
    
    <li><b>Step.2</b></li>
    <p>Once oracle download link is loaded then choose version either latest or any other version and also choose your operating system</p>
      <a href="images/jdkwindow.png">
            <img alt="img" src="images/jdkwindow.png" />
        </a>
        

    
    <li><b>Step.3</b></li>
    <p>Once a download is done then open and simply install at your drive/folder</p>
