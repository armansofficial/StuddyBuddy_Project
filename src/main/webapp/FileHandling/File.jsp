...
<div class="card">
    <div class="left-side">
        ...
        <li><a href="featuresjava.jsp">Features of java</a></li>
          <li><a href="">Application</a></li>
           <li><a href="">JDK JVM & JRE</a></li>
            <li><a href="">Download JDK</a></li>
             <li><a href="">Seating path</a></li>
              <li><a href="">Name Convention</a></li>
               <li><a href="">Exploring first program</a></li>
                <li><a href="">Writing first program</a></li>
                </ul>
                </div>
...
<div class="additional-content">
    ...
    <h1>File handling</h1>
        <h2>Why file handling is use less.?</h2>
       
        <p>
       This section covers the basic concepts of handling files, that is generally used for smaller programs. This is because maintaining a huge amount of data is a difficult effort, that is why databases are used to store huge amounts of data.   
        </p>
        
         <h1>Stream</h1>
        
        <p>
    Let's begin with learning about <b>stream</b> because these are sometimes asked in <b>interviews</b>.
The question now is: What is a <b>stream?</b>
This stream was introduced in <b>Java 8</b> and is used by the <b>Stream API</b> to process object collections.in short <b>stream  is a flow of data.</b>
  

        </p>
        
     
        <h3>Java File Class</h3>
        <p>
       By this class, which represents an abstract representation of a file, you may create new files, get file paths, get file names, and more.    
        </p>
