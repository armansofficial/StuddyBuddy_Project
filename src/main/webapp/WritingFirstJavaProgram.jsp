...
<title>Writing first java program</title>
...
<div class="additional-content">
    ...
    <h1>Writing first java program</h1>
    <p>Java is an object-oriented programming language that is widely used in developing software applications. It is a popular choice among developers due to its versatility and flexibility. If you are new to Java, writing your first program can be an exciting and challenging experience. In this article, we will guide you through the process of writing your first Java program.</p>
    
   
<p>
<ul>
<li><b>
Step 1: Setting up the environment</b></li>

Before you start writing your first Java program, you need to make sure that you have the necessary tools and environment set up. You will need a Java Development Kit (JDK) which includes the Java compiler, debugger, and other tools required for writing and running Java programs. You can download the latest JDK version from the official Oracle website.

<li><b>Step 2: Choose a text editor</b></li>
Java programs are written in plain text, so you can use any text editor to write your code. However, it is recommended to use a text editor specifically designed for writing code, such as Eclipse, NetBeans, or IntelliJ IDEA. These editors offer features like syntax highlighting, code completion, and debugging tools, which can make your coding experience easier.
<li><b>Step 3: Write your first program</b></li>
<p>Now that you have your environment set up and text editor ready, it's time to write your first Java program. The first program that every beginner writes is called 'Hello World'. It is a simple program that displays the text 'Hello World' on the screen. Here's how you can write it:</p>
  <a href="images/helloworld.png">
            <img alt="hello world program" src="images/helloworld.png" />
        </a>


<li><b>Step 4: Compile and run the program</b></li>
<p>Once you have written the code, save the file with the extension <b>.java</b>. In this case, the file name should be <b>HelloWorld.java</b>. Next, you need to compile the code using the Java compiler. Open your command prompt or terminal, navigate to the directory where you have saved your file, and type the following command:</p>
<b>javac HelloWorld.java</b>
<p>If there are no errors in your code, the compiler will create a new file called `HelloWorld.class`, which contains the bytecode of your program. To run the program, type the following command in the terminal:</p><br>

<b>java HelloWorld</b>
<li>Congratulations, you have successfully written and executed your first Java program!</li>
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/kneEWgxYRg8?si=YLIK5jmcNUJEv7Bh" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>