...
<div class="additional-content">
    ...
    <li>
    <b>Object Oriented:</b>
    <p>Java is a Object Oriented Programming language that's means we need to create a object if we want to access the attribute and method of class. Java is class based That's mean it is mandatory to define a class either program is smaller and bigger</p>
    </li>
    
    
    <li><b>Multi threaded:</b></li>
    <p>Multi threaded is the important concept in Java in threading topic we are going to see about it in details. It help to run multiple thread simultaneously</p>
    

    
    <li><b>Secure:</b></li>
    <p>Java is Secure programming language that why Java is used among the world and developer choice </p>

    <li><b>Platform Independent</b></li>
    <p>Java is the platform independent and this is the important feature of java. Write once's Run anywhere</p> 
    
     <li><b>High Performance</b></li>
     <p>Java provide high Performance as compare to other programming language</p>
