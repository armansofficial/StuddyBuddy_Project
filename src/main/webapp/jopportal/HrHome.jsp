...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
   ...
   <%if (session.getAttribute("email")==null) {
	 	%>
	 	<jsp:forward page="http://localhost:8879/ST/jopportal/HRLogin.jsp"></jsp:forward>
	 	<% 
   }
   %> 
<!DOCTYPE html>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				if(msg!=null) { %>
					<h5 class="text-center text-primary"><%=msg %></h5>
			<% }
				%>
				<div class="card">
					<div class="card-body">
								...
								<form method="post" action=http://localhost:8879/ST/LogOut>
				...
				List<Jobs> list = jobdao.activeJobs();
					...
					<div class="card-body">
						...
						<div class="text-center">
							<a href="Viewmore.jsp?id=<%=j.getId()%>"
								class="btn btn-sm bg-danger text-white">Full Jobs</a>
                            
                            <a href="edit_jobs.jsp?id=<%=j.getId()%>"
								class="btn btn-sm bg-danger text-white">Edit Job</a>
								
								<a href="edit_jobs.jsp?id=<%=j.getId()%>"
								class="btn btn-sm bg-danger text-white">Delete Job</a>
