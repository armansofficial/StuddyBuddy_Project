...
<div class="additional-content">
    ...
    <h1>Name Convention</h1>
     <p>In this tutorial we learn about naming convention that mean's in which way we are writing our variable class etc.. </p>  
  <ul>
  <li><b>Camel Case:</b>
  </li>
  <p><b>Camel Case:</b>This case is used to declare variable, methods</p>
  
 
  </ul>  <a href="images/camelCase.png">
            <img alt="A screenshot showing" src="images/camelCase.png" />
        </a>
        
        
          <li><b>Pascal Case:</b>
  </li>
  <p><b>Pascal Case:</b>This case is used to declare class, interface</p>
  
 
  </ul>  <a href="images/pascalcase.png">
            <img alt="A screenshot showing" src="images/pascalcase.png" />
